System.register(["../Models/Window", "../Errors/ApiConfigurationValidationError"], function (exports_1, context_1) {
    var __moduleName = context_1 && context_1.id;
    var Window_1, ApiConfigurationValidationError_1, ApiService;
    return {
        setters: [
            function (Window_1_1) {
                Window_1 = Window_1_1;
            },
            function (ApiConfigurationValidationError_1_1) {
                ApiConfigurationValidationError_1 = ApiConfigurationValidationError_1_1;
            }
        ],
        execute: function () {
            ApiService = (function () {
